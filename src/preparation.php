  ...
  <body class="min-h-full min-w-full text-sm">
    ...
    <div class="flex gap-1.5 mt-2 items-center text-base print:hidden">
      ...
      <div class="btn-block">
        ...
        <button type="button"><a href="./parametrage.php">Paramétrage</a></button>
      </div>
      <div class="btn-block">
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="bg-[#EDEDED] flex flex-col h-fit w-fit pb-2 print:hidden">
      ...
      <div class="flex">
        <div class="btn-sblock">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart-plus size-8 mt-4 text-gray-400"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div class="btn-sblock">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-ripple size-8 mt-4"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <button type="button">Vagues</button>
        </div>
        <div class="btn-sblock">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-clipboard-list size-8 mt-4"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path
              d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2"
        ...
        <div class="flex flex-col ml-4 items-center">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-scan size-8 mt-4"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <p class="underline underline-offset-8 cursor-default">Ramasses</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <div class="btn-sblock">
          ...
          <button type="button" class="text-pretty">
        ...
        <div class="btn-sblock">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-package-import size-8 mt-4"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <button type="button">Réappro.</button>
        </div>
        ...
        <div class="btn-sblock">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart-share size-8 mt-4"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path d="M4 19a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
            <path d="M12.5 17h-6.5v-14h-2" />
          ...
          <button type="button">Transfert ZPA</button>
        </div>
        ...
        <div class="btn-sblock">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-folders size-8 mt-4"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path
          ...
          <button type="button">Réorganisation</button>
        </div>
        ...
        <div class="flex flex-col ml-4 mt-2 items-center text-nowrap">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-table-shortcut size-8"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path
      ...
      >
        <p class="pl-8">Préparation</p>
        <p class="pl-24">Picking</p>
        <p>Répartition</p>
    ...
    <button
      type="button"
      class="mt-2 ml-2 border-solid bg-[#EDEDED] px-4 py-1.5 polygon print:hidden"
    >
      Commandes
    </button>
    <div class="border-solid border-b-black border-b-2 print:hidden"></div>
    <!--Regroupe les deux parties de la page -->
    <div class="flex">
      <!--partie Commandes-->
      <div class="bg-[#E0E0E0] flex flex-col border-solid text-lg print:hidden">
        <h1
          class="text-[#999999] font-bold border-2 border-solid text-center p-2 border-gray-400 m-2"
        >
          Commandes
        </h1>
        <div class="flex flex-col gap-2 m-4">
          ...
          >
            <div
              class="rounded-full size-5 border-4 border-solid border-[#C0C0C0] bg-gray-800 shadow-sm hover:bg-gray-500  hover:cursor-pointer"
            ></div>
            <p>En Saisie</p>
          </div>
          <div
          ...
          >
            <div
              class="rounded-full size-5 border-4 border-solid border-[#C0C0C0] shadow-sm hover:bg-gray-500  hover:cursor-pointer"
            ></div>
            <p>En vague</p>
          </div>
          <div
          ...
          >
            <div
              class="rounded-full size-5 border-4 border-solid border-[#C0C0C0] shadow-sm hover:bg-gray-500  hover:cursor-pointer"
            ></div>
            <p class="text-nowrap">En préparation</p>
          </div>
          <div
            class="flex gap-2 items-center "
          >
      ...
      <!--partie - Commandes En saisie-->
      <div>
        <div class="flex gap-2 items-center mt-2 ml-2 font-bold print:hidden">
          <div class="px-2 border-2 border-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <h1 class="text-gray-700 text-nowrap text-lg">
            Commandes - En Saisie
          </h1>
        </div>
        <!--Form + Table + Buttons-->

        <form action="preparation.php" method="POST" name="form" enctype="multipart/form-data" class="mt-2">
        <div class="flex justify-between bg-gray-200 p-1.5 print:hidden">
          <!--Form-->
          <div>
              <div class="flex flex-col gap-4 items-center">
                <div class="flex gap-4">
                  <label for="client" class="text-nowrap text-gray-500"
                    >Compte client
                  </label>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="icon icon-tabler icons-tabler-outline icon-tabler-search text-[#C0C0C0]"
                    id="client"
                  >
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" />
                  ...
                  <input type="text" id="client" disabled name="client" class="input-field hover:cursor-not-allowed" />
                  <input type="text" id="client" disabled name="client" class="input-field hover:cursor-not-allowed" />
                  <label for="commande" class="text-nowrap ml-2"
                    >N° commande</label
                  >
                  <input id="commande" name="commande" disabled type="text" class="input-field" />
                </div>
                <div class="flex gap-4">
                  <label for="site" class="text-nowrap ml-16 text-gray-500"
                    >Site
                  </label>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <input type="text" id="site" name="site" disabled class="input-field hover:cursor-not-allowed" />
                  <input type="text" id="site" name="site" disabled class="input-field hover:cursor-not-allowed" />
                  <label for="reference" class="text-nowrap"
                    >Réf. commande</label
                  >
                  <input id="reference" type="text" name="reference" class="input-field" />
                </div>
              </div>
              <div class="flex gap-4 items-center">
                <div class="flex flex-col mt-2 justify-center">
                  <div class="flex gap-10">
                    <label for="debut" class="text-nowrap">Date de début</label>
                    <input
                      type="date"
                      id="debut"
                      name="debut"
                      class="input-field px-[2.32rem]"
                    />
                  </div>
                  <div class="flex gap-10 mt-2">
                    <label for="fin" class="text-nowrap">Date de fin</label>
                    <input
                      type="date"
                      id="fin"
                      name="fin"
                      class="input-field px-[2.32rem] ml-[1.3rem]"
                      
                    />
                  </div>
                </div>
                <div class="ml-4">
                  <label for="periode">Choix de la période</label>
                  <select id="periode" class="input-field px-10">
                    <option value="default-value">
                      Défini par l'utilisateur
                    </option>
                    <option value="option-1">3 ans</option>
                    <option value="option-2">2 jours</option>
                    <option value="option-3">10 ans</option>
                  </select>
                </div>
                <div>
                  <label for="date-periode" class="text-nowrap"
                    >Date correspondant à la période</label
                  >
                  <select id="date-periode" class="input-field px-10">
                    <option value="default-option">Date de création</option>
                    <option value="option-1">11/01</option>
                    <option value="option-2">24/09</option>
                    <option value="option-3">30/03</option>
                  </select>
                </div>
              </div>
          </div>
          ...
          <div class="flex flex-col">
            <!--Table-->
            <table
              class="border-collapse border-2 border-solid border-gray-700"
            >
              <thead class="bg-gray-500 text-white">
                <th scope="col">Activité</th>
                <th scope="col">En saisie</th>
                <th scope="col">En prép.</th>
              </thead>
              <tbody class="font-bold">
                <tr>
                  <td class='p-4'>EPX_UPM</td>
                  <td class="text-right px-10">0</td>
                  <td class="text-right px-10">0</td>
                </tr>
              </tbody>
            </table>
            ...
            <div class="flex gap-2 mt-2">
              <button
                type="button"
                class="border-2 border-solid border-gray-300 flex items-center gap-2 p-2 hover:bg-[#C0C0C0] hover:border-gray-700"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <button
                class="border-2 border-solid border-gray-300 p-2 flex gap-2 items-center hover:bg-[#C0C0C0] hover:border-gray-700 hover:cursor-pointer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
...
<label for="file">
              ...
              <input id="file" class="hidden" name="file" type="file" accept=".xls, .csv, .xlsx, .xlsm, .xlsb">
              </button>
<button class="border-2 border-solid border-gray-300 p-2 flex items-center hover:bg-[#C0C0C0] hover:border-gray-700 gap-2 hover:cursor-pointer">
           <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
...
<input type="submit" name="prep" class="hidden">
</form>
        </div>
        <!--Partie paramètres - Commandes en saisie -->
        <div class="flex justify-between print:hidden">
          ...
          <div class="flex items-center gap-2">
            ...
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="icon icon-tabler icons-tabler-outline icon-tabler-printer hover:cursor-pointer hover:text-gray-500"
            ...
            <div class="flex">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="icon icon-tabler icons-tabler-outline icon-tabler-layout-board-split text-green-500 border-r-2 border-r-gray-500"
              >
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path
                  d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"
            ...
            <div class="flex">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="icon icon-tabler icons-tabler-outline icon-tabler-link border-r-2 border-r-gray-500"
              >
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M9 15l6 -6" />
            ...
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="icon icon-tabler icons-tabler-outline icon-tabler-checklist border-r-2 border-r-gray-500"
            >
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <path
            ...
            <select id="filtre" class="input-field px-2">
        ...
        <div>
          ...
          >
            <thead class="bg-gray-500 text-white border-2 border-solid">
              ...
              <th scope="col" class="p-4 border-2 border-solid">Numéro entête</th>
              <th scope="col" class="p-4 border-2 border-solid">Référence donneur ordre</th>
              <th scope="col" class="p-4 border-2 border-solid">Destinataire</th>
              <th scope="col" class="p-4 border-2 border-solid">Filière de préparation</th>
              <th scope="col" class="p-4 border-2 border-solid">Date de livraison</th>
              <th scope="col" class="p-4 border-2 border-solid">Code transporteur</th>
              <th scope="col" class="p-4 border-2 border-solid">Taux de disponibilité absolu</th>
              <th scope="col" class="p-4 border-2 border-solid">Date de création</th>
            </thead>
<tbody>
<?php
